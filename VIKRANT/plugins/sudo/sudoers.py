...
from VIKRANT.misc import SUDOERS
from VIKRANT.utils.database import add_sudo, remove_sudo
from VIKRANT.utils.decorators.language import language
from VIKRANT.utils.extraction import extract_user
...
async def check_sudo_list(client, callback_query: CallbackQuery):
    ...
    if callback_query.from_user.id not in SUDOERS:
        return await callback_query.answer("Olelele Munna 😂 \n 𝗦ᴜᴅᴏʟɪsᴛ 𝗗ᴇᴋʜɴᴇ ᴀᴀʏᴀ ᴍᴄ 🤧🖕", show_alert=True)
    else:
